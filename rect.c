...
static __force_inline void Rect_union (const Rect *src_1, const Rect *src_2, Rect *dst)
{
	...
	s32 left_x = lowest_of_s32 (src_1->left_x, src_2->left_x);
	s32 x_off = highest_of_s32 (src_1->left_x + src_1->width, src_2->left_x + src_2->width);
	s32 top_y = lowest_of_s32 (src_1->top_y, src_2->top_y);
	s32 y_off = highest_of_s32 (src_1->top_y + src_1->height, src_2->top_y + src_2->height);
...
static __force_inline int Rect_intersection (const Rect *src_1, const Rect *src_2, Rect *dst)
{
	...
	s32 left_x = highest_of_s32 (src_1->left_x, src_2->left_x);
	s32 x_off = lowest_of_s32 (src_1->left_x + src_1->width, src_2->left_x + src_2->width);
	s32 top_y = highest_of_s32 (src_1->top_y, src_2->top_y);
	s32 y_off = lowest_of_s32 (src_1->top_y + src_1->height, src_2->top_y + src_2->height);
