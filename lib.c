...
static __force_inline s32 lowest_of_s32 (s32 arg1, s32 arg2)
{
	if (arg1 <= arg2)
		return arg1;
	else
...
static __force_inline s32 highest_of_s32 (s32 arg1, s32 arg2)
{
	if (arg1 >= arg2)
		return arg1;
	else
...
static __force_inline u64 lowest_of_u64 (u64 arg1, u64 arg2)
{
	if (arg1 <= arg2)
		return arg1;
	else
...
static __force_inline u64 highest_of_u64 (u64 arg1, u64 arg2)
{
	if (arg1 >= arg2)
		return arg1;
	else
...
// This strange order of the iterative bit reversal is enough to fool GCC into not using its __builtin_bswap64 for the three high-order swaps (bswap64 swaps bytes, not bits)
