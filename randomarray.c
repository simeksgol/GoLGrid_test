...
// The intended way to make use of this is to verify just once that the size is enough with RandomDataArray_verify_size, then access the array directly with rda_object->random_data [index]
...
static __noinline int RandomDataArray_verify_size (const RandomDataArray *rda, u64 needed_size)
{
